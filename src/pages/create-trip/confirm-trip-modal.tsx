            ...
            <div className="space-y-2">
              ...
              {props.tripStartDate && props.tripEndDate ? (
                <p className="text-sm text-zinc-400">
                  Para concluir a criação da viagem para <span className="font-semibold text-zinc-100">{props.tripDestination}</span> nas datas de <span className="font-semibold text-zinc-100">
                  {`${format(props.tripStartDate, 'd/MM')} a ${format(props.tripEndDate, 'd/MM')} de ${format(props.tripEndDate, 'y')}`}</span> preencha seus dados abaixo: 
                </p>
              ): null}
